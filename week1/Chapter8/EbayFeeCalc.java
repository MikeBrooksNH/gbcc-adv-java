...
public class EbayFeeCalc {
   ...
   public double ebayFee(double sellPrice) {
   ...
   public static void main(String[] args) {
      ...
      EbayFeeCalc itemForSale = new EbayFeeCalc();
      
      // User defined selling price
      double sellingPrice; 
      ...
      System.out.println("eBay fee: $" + itemForSale.ebayFee(sellingPrice));
   }
}